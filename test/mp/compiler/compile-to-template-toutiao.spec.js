...
describe('compilteToTemplate: wechat', () => {
  ...
  it('generate v-if', () => {
    assertCodegen(
      ...
      `<view tt:if="{{ h[ 1 ]._if }}" class="_div {{p}}"></view>`
    )
    assertCodegen(
      (
        `<div v-if="code === 200"></div>` +
      ...
      (
        `<view tt:if="{{ h[ 1 ]._if }}" class="_div {{p}}"></view>` +
        `<view tt:else class="_div {{p}}"></view>`
      )
    )
    assertCodegen(
      (
      ...
      (
        `<view tt:if="{{ h[ 1 ]._if }}" class="_div {{p}}">{{ h[ 2 ].t }}</view>` +
        `<view tt:elif="{{ h[ 3 ]._if }}" class="_div {{p}}">{{ h[ 4 ].t }}</view>`
      )
    )
    assertCodegen(
      (
      ...
      (
        `<view tt:if="{{ h[ 1 ]._if }}" class="_div {{p}}">{{ h[ 2 ].t }}</view>` +
        `<view tt:elif="{{ h[ 3 ]._if }}" class="_div {{p}}">{{ h[ 4 ].t }}</view>` +
        `<view tt:else class="_div {{p}}">{{ h[ 6 ].t }}</view>`
      )
    )
  })
  ...
  it('generate v-for', () => {
    assertCodegen(
      ...
      (
        `<view tt:for="{{ h[ 1 ].li }}" tt:for-item="item" tt:for-index="item_i1" class="_div {{p}}">` +
    ...
    assertCodegen(
      ...
      (
        `<view tt:for="{{ h[ 1 ].li }}" tt:for-item="item" tt:for-index="index" class="_div {{p}}">` +
    ...
    assertCodegen(
      ...
      (
        `<view tt:for="{{ h[ 1 ].li }}" tt:key="id" tt:for-item="item" tt:for-index="index" class="_div {{p}}">` +
          `<view class="_div {{p}}">{{ h[ 3 + '-' + (item_i2 !== undefined ? item_i2 : index) ].t }}</view>` +
        `</view>`
      )
    )
    assertCodegen(
      ...
      (
        `<view tt:for="{{ h[ 1 ].li }}" tt:key="id" tt:for-item="item" tt:for-index="index" class="_div {{p}}">` +
          `<view tt:for="{{ h[ 2 + '-' + (item_i2 !== undefined ? item_i2 : index) ].li }}" tt:key="id" tt:for-item="e" tt:for-index="i" class="_div {{p}}">` +
    ...
    assertCodegen(
      ...
      (
        `<view tt:for="{{ h[ 1 ].li }}" tt:key="id" tt:for-item="item" tt:for-index="item_i1" class="_div {{p}}">` +
          `<view tt:for="{{ h[ 2 + '-' + (item_i2 !== undefined ? item_i2 : item_i1) ].li }}" tt:key="id" tt:for-item="e" tt:for-index="e_i1" class="_div {{p}}">` +
    ...
    assertCodegen(
      ...
      (
        `<block tt:for="{{ h[ 1 ].li }}" tt:for-item="item" tt:for-index="item_i1">` +
          `<view tt:key="id" class="_div {{p}}">{{ h[ 3 + '-' + (item_i2 !== undefined ? item_i2 : item_i1) ].t }}</view>` +
        `</block>`
      )
    )
  })
...
describe('slot', () => {
  ...
  it('slot inside v-for', () => {
    ...
    assertCodegen(
      ...
      (
        `<view class="_div {{p}}">` +
          `<view tt:for="{{ h[ 2 ].li }}" tt:for-item="item" tt:for-index="item_i1" class="_div {{p}}">` +
    ...
    assertCodegen(
      ...
      function aasertRes (res) {
        res.slots.forEach((slot) => {
          ...
          expect(slot.body).toEqual(
            `<template name="${slot.slotName}" parent="${options.name}">` +
              `<label tt:for="{{ s[ 's4' + (_t || '') ].li }}" tt:for-item="item" tt:for-index="item_i1" class="_span {{p}}">` +
    ...
    assertCodegen(
      ...
      function aasertRes (res) {
        res.slots.forEach((slot) => {
          ...
          expect(slot.body).toEqual(
            `<template name="${slot.slotName}" parent="${options.name}">` +
              `<label tt:for="{{ s[ 's5' + (_t || '') ].li }}" tt:for-item="item" tt:for-index="item_i1" class="_span {{p}}">` +
    ...
    assertCodegen(
      ...
      function aasertRes (res) {
        res.slots.forEach((slot) => {
          ...
          expect(slot.body).toEqual(
            `<template name="${slot.slotName}" parent="${options.name}">` +
              `<label class="_span {{p}}" data-cid="{{ _c || c }}" data-hid="{{ 's4' + _t }}" bindtap="_pe">` +
                `click` +
              `</label>` +
            `</template>`
          )
