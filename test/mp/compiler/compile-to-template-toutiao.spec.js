...
describe('compilteToTemplate: wechat', () => {
  ...
  it('generate v-if', () => {
    assertCodegen(
      ...
      `<view tt:if="{{ h[ 1 ]._if }}" class="_div"></view>`
    )
    assertCodegen(
      (
        `<div v-if="code === 200"></div>` +
    ...
    assertCodegen(
      ...
      (
        `<view tt:if="{{ h[ 1 ]._if }}" class="_div">{{ h[ 2 ].t }}</view>` +
        `<view tt:elif="{{ h[ 3 ]._if }}" class="_div">{{ h[ 4 ].t }}</view>`
      )
    )
    assertCodegen(
      (
      ...
      (
        `<view tt:if="{{ h[ 1 ]._if }}" class="_div">{{ h[ 2 ].t }}</view>` +
        `<view tt:elif="{{ h[ 3 ]._if }}" class="_div">{{ h[ 4 ].t }}</view>` +
        `<view tt:else class="_div">{{ h[ 6 ].t }}</view>`
      )
    )
  })
  ...
  it('generate v-for', () => {
    assertCodegen(
      ...
      (
        `<view tt:for="{{ h[ 1 ].li }}" tt:for-item="item" tt:for-index="item_i1" class="_div">` +
    ...
    assertCodegen(
      ...
      (
        `<view tt:for="{{ h[ 1 ].li }}" tt:for-item="item" tt:for-index="index" class="_div">` +
    ...
    assertCodegen(
      ...
      (
        `<view tt:for="{{ h[ 1 ].li }}" tt:key="id" tt:for-item="item" tt:for-index="index" class="_div">` +
          `<view class="_div">{{ h[ 3 + '-' + (item_i2 !== undefined ? item_i2 : index) ].t }}</view>` +
        `</view>`
      )
    )
    assertCodegen(
      ...
      (
        `<view tt:for="{{ h[ 1 ].li }}" tt:key="id" tt:for-item="item" tt:for-index="index" class="_div">` +
          `<view tt:for="{{ h[ 2 + '-' + (item_i2 !== undefined ? item_i2 : index) ].li }}" tt:key="id" tt:for-item="e" tt:for-index="i" class="_div">` +
    ...
    assertCodegen(
      ...
      (
        `<view tt:for="{{ h[ 1 ].li }}" tt:key="id" tt:for-item="item" tt:for-index="item_i1" class="_div">` +
          `<view tt:for="{{ h[ 2 + '-' + (item_i2 !== undefined ? item_i2 : item_i1) ].li }}" tt:key="id" tt:for-item="e" tt:for-index="e_i1" class="_div">` +
    ...
    assertCodegen(
      ...
      (
        `<block tt:for="{{ h[ 1 ].li }}" tt:for-item="item" tt:for-index="item_i1">` +
          `<view tt:key="id" class="_div">{{ h[ 3 + '-' + (item_i2 !== undefined ? item_i2 : item_i1) ].t }}</view>` +
        `</block>`
      )
    )
  })
  ...
  it('generate component', () => {
    ...
    assertCodegen(
      ...
      (
        `<template is="${CompA.name}" data="{{ ...$root[ cp + 0 + (_t || '') ], $root, _t: _t || '',p:p||'' }}" tt:if="{{ h[ 1 ]._if }}" />` +
        `<template is="${CompB.name}" data="{{ ...$root[ cp + 1 + (_t || '') ], $root, _t: _t || '',p:p||'' }}" tt:else />`
      ),
      options
    )
    assertCodegen(
      ...
      (
        `<template is="${CompA.name}"` +
          ...
          ` tt:for="{{ h[ 1 ].li }}" tt:for-item="item" tt:for-index="item_i1"` +
        ` />`
      ),
      options
    )
...
describe('slot', () => {
    ...
    assertCodegen(
      ...
      (
        `<view class="_div">` +
          ...
          `<template is="{{ s_head || '${slot1}' }}" data="{{ ...$root[ c ], $root, _t: _t || '',p:p||'', _c: c }}" tt:if="{{ h[ 2 ]._if }}"/>` +
          `<template name="${slot2}">default slot</template>` +
          `<template is="{{ s_default || '${slot2}' }}" data="{{ ...$root[ c ], $root, _t: _t || '',p:p||'', _c: c }}" tt:if="{{ h[ 4 ]._if }}"/>` +
        `</view>`
      ),
      options
    )
        ...
        res.slots.forEach((slot) => {
          ...
          expect(slot.body).toEqual(
            `<template name="${slot.slotName}" parent="${options.name}">` +
              `<view class="_div {{d}}">{{ s[ 's6' + _t ].t }}</view>` +
            `</template>`
          )
        })
      }
        ...
        res.slots.forEach((slot) => {
          if (slot.name === 'head') {
            expect(slot.body).toEqual(
              `<template name="${slot.slotName}" parent="${options.name}">` +
                `<view class="_p {{d}}">` +
                  `<label class="_span {{d}}">{{ s[ 's7' + _t ].t }}</label>` +
                `</view>` +
              `</template>`
            )
      ...
      function aasertRes (res) {
        ...
        expect(slot1.body).toEqual(
          `<template name="${slot1.slotName}" parent="${options.name}">` +
            `<view class="_div {{d}}">{{ s[ 's8' + _t ].t }}</view>` +
          `</template>`
        )
  ...
  it('slot inside v-for', () => {
    ...
    assertCodegen(
      ...
      (
        `<view class="_div">` +
          `<view tt:for="{{ h[ 2 ].li }}" tt:for-item="item" tt:for-index="item_i1" class="_div">` +
  ...
  it('slot with v-for', () => {
    ...
    assertCodegen(
      ...
      (
        `<view class="_div">` +
          `<template name="${slot1}"></template>` +
          `<template is="{{ s_default || '${slot1}' }}" data="{{ ...$root[ c ], $root, _t: (_t || '') + '-' + (item_i2 !== undefined ? item_i2 : item_i1),p:p||'', _c: c }}" tt:for="{{ h[ 2 ].li }}" tt:for-item="item" tt:for-index="item_i1"/>` +
        `</view>`
      ),
      options
    )
    ...
    assertCodegen(
      ...
      function aasertRes (res) {
        res.slots.forEach((slot) => {
          ...
          expect(slot.body).toEqual(
            `<template name="${slot.slotName}" parent="${options.name}">` +
              `<label tt:for="{{ s[ 's4' + (_t || '') ].li }}" tt:for-item="item" tt:for-index="item_i1" class="_span {{d}}">` +
  ...
  it('define component and slot inside v-for', () => {
    ...
    assertCodegen(
      ...
      (
        `<view class="_div">` +
          `<block tt:for="{{ h[ 2 ].li }}" tt:for-item="item" tt:for-index="item_i1">` +
            `<template is="${CompA.name}"` +
    ...
    assertCodegen(
      ...
      function aasertRes (res) {
        res.slots.forEach((slot) => {
          ...
          expect(slot.body).toEqual(
            `<template name="${slot.slotName}" parent="${options.name}">` +
              `<label tt:for="{{ s[ 's5' + (_t || '') ].li }}" tt:for-item="item" tt:for-index="item_i1" class="_span {{d}}">` +
    ...
    assertCodegen(
      ...
      function aasertRes (res) {
        res.slots.forEach((slot) => {
          ...
          expect(slot.body).toEqual(
            `<template name="${slot.slotName}" parent="${options.name}">` +
              `<label class="_span {{d}}" data-cid="{{ _c || c }}" data-hid="{{ 's4' + _t }}" bindtap="_pe">` +
                `click` +
              `</label>` +
            `</template>`
          )
