...
describe('compilteToTemplate: swan', () => {
  ...
  it('generate events', () => {
    ...
    assertCodegen(
      ...
      `<input class="_input {{p}}" data-cid="{{ _c || c }}" data-hid="{{ 1 }}" bind:blur="_pe"/>`
    )
    assertCodegen(
  ...
  it('generate component', () => {
    ...
    assertCodegen(
      ...
      (
        `<template is="${CompA.name}" data="{{{ ...$root[ cp + 0 + (_t || '') ], $root, _t: _t || '',p:p||'' }}}" s-if="{{ h[ 1 ]._if }}" />` +
        `<template is="${CompB.name}" data="{{{ ...$root[ cp + 1 + (_t || '') ], $root, _t: _t || '',p:p||'' }}}" s-else />`
      ),
      options
    )
    assertCodegen(
      ...
      (
        `<template is="${CompA.name}"` +
          ` data="{{{ ...$root[ cp + 0 + (_t || '') + '_' + (item_i2 !== undefined ? item_i2 : item_i1) ], $root, _t: (_t || '') + '_' + (item_i2 !== undefined ? item_i2 : item_i1),p:p||'' }}}"` +
  ...
  it('generate v-model', () => {
    assertCodegen(
      `<input v-model="input">`,
      `<input class="_input {{p}}" value="{{ h[ 1 ].value }}" data-cid="{{ _c || c }}" data-hid="{{ 1 }}" bind:input="_pe"/>`
    )
    assertCodegen(
    ...
    assertCodegen(
      ...
      `<input class="_input {{p}}" value="{{ h[ 1 ].value }}" data-cid="{{ _c || c }}" data-hid="{{ 1 }}" bind:blur="_pe"/>`
    )
    assertCodegen(
      `<input v-model.number="input">`,
      `<input class="_input {{p}}" value="{{ h[ 1 ].value }}" data-cid="{{ _c || c }}" data-hid="{{ 1 }}" bind:input="_pe" bind:blur="_pe"/>`
    )
  })
