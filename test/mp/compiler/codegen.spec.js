...
describe('codegen', () => {
  ...
  it('generate v-for directive', () => {
    assertCodegen(
      ...
      `with(this){return _c('div',{attrs:{"_hid":0}},_l((items),function(item,item_index$0){return _c('li',{key:item.uid,attrs:{"_hid":1 + '-' + item_index$0,"_fk":"uid"}})},1,_self))}`
    )
    // iterator syntax
    assertCodegen(
      '<div><li v-for="(item, i) in items"></li></div>',
      `with(this){return _c('div',{attrs:{"_hid":0}},_l((items),function(item,i){return _c('li',{attrs:{"_hid":1 + '-' + i}})},1,_self))}`
    )
    ...
    assertCodegen(
      ...
      `with(this){return _c('div',{attrs:{"_hid":0}},[_c('p',{attrs:{"_hid":1}}),_l((items),function(item,item_index$0){return _c('li',{attrs:{"_hid":2 + '-' + item_index$0}})},2,_self)],2)}`
    )
  })
  ...
  it('generate component with v-for', () => {
    ...
    assertCodegen(
      ...
      `with(this){return _c('div',{attrs:{"_hid":0}},[_c('child',{attrs:{"_hid":1,"_cid":0}}),_l((list),function(item,item_index$0){return [_v(_s(item),4 + '-' + item_index$0)]},3,_self)],2)}`
    )
  })
